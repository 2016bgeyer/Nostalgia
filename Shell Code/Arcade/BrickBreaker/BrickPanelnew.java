      ...
      public BrickPanelnew()
      {
         ...
         for(int row = 0; row<myBrickarray.length; row++)
         {
            for(int col = 0; col<myBrickarray[0].length;col++)
            {
               ...
               if(col==0&&row==0)
                  myBrickarray[row][col] = new Bumper(25+brickwidth,40+bricklength,brickwidth,bricklength,Color.RED);
            	
               myBrickarray[row][col] = new Bumper(x,y,brickwidth,bricklength,Color.RED);
            }
         }
      ...
      public void resetBricks(Bumper[][] array)
      {
         ...
         for(int row = 0; row<array.length; row++)
         {
            for(int col = 0; col<array[0].length;col++)
            {
               ...
               y=row*10+row*bricklength+40;
               if(col==0&&row==0)
                  array[row][col] = new Bumper(25+brickwidth,40+bricklength,brickwidth,bricklength,Color.RED);
            	
               array[row][col] = new Bumper(x,y,brickwidth,bricklength,Color.RED);
            }
         }
      }
